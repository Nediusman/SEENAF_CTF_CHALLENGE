-- SEENAF CTF - Complete Database Setup
-- Run this entire script in Supabase SQL Editor

-- Step 1: Create enums
CREATE TYPE IF NOT EXISTS public.difficulty_level AS ENUM ('easy', 'medium', 'hard', 'insane');
CREATE TYPE IF NOT EXISTS public.app_role AS ENUM ('admin', 'player');
...
-- Step 12: Make your user admin (REPLACE EMAIL!)
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'admin'
FROM auth.users 
...
-- Step 13: Insert sample challenges
...
-- Step 14: Enable realtime for leaderboard updates
