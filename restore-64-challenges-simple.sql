-- RESTORE 64 CHALLENGES - Simple Version
-- Run this in Supabase SQL Editor

-- First, let's add a unique constraint on title to prevent duplicates
ALTER TABLE challenges ADD CONSTRAINT challenges_title_unique UNIQUE (title);

-- Now insert all the missing challenges
...
-- Additional Reverse Engineering Challenges
...
SELECT 'All challenges restored!' as status;
