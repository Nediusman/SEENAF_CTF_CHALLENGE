-- Complete database setup for SEENAF CTF
-- Run this in Supabase SQL Editor after making yourself admin
...
-- Step 2: Create challenge_likes table
...
-- Step 3: Enable RLS on challenge_likes
ALTER TABLE challenge_likes ENABLE ROW LEVEL SECURITY;

-- Step 4: Create policies for challenge_likes
...
-- Step 5: Create functions and triggers for automatic counting
...
-- Step 6: Clear any existing challenges (optional)
-- DELETE FROM challenges;

-- Step 7: Insert sample challenges
INSERT INTO challenges (title, description, category, difficulty, points, flag, hints, author, instance_url, solver_count, likes_count) VALUES
